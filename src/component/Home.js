...
const Home = () => {
  ...
  const downloadResume = () => {
    ...
    link.href = "https://ridoy-mondol.github.io/portfolio/Ahatashamul.pdf";
    link.setAttribute("download", "Ahatashamul_Resume.pdf");
            ...
            <div className="col-md-6 d-flex align-items-center">
              <div className="overflow-hidden">
                <div ref={h4Ref} id="home-h4">
                  <h4
                    className={`home-text home-margin ${
                      isH4Intersecting ? "leftIn" : ""
                    }`}
                  >
                    Hi, It's Me
                  </h4>
                ...
                <div ref={h1Ref} id="home-h1">
                  <h1
                    className={`hide-item home-white-txt ${
                      isH1Intersecting ? "leftIn" : ""
                    } ${mode ? "dark" : ""}`}
                  >
                    AHATASHAMUL ISLAM
                  </h1>
                ...
                <div ref={h2Ref} id="home-h2">
                  <h2
                    className={`hide-laptop home-white-txt ${
                      isH2Intersecting ? "leftIn" : ""
                    } ${mode ? "dark" : ""}`}
                  >
                    AHATASHAMUL ISLAM
                  </h2>
                ...
                <div ref={h42Ref} id="home-h42">
                  <h4
                    className={`home-white-txt ${
                      isH42Intersecting ? "leftIn" : ""
                    } ${mode ? "dark" : ""}`}
                  >
                    And I'm a{" "}
                    <span className="home-text">Full Stack Developer</span> &{" "}
                ...
                <div ref={pRef} id="home-p">
                  <p
                    className={`my-description ${
                      isPIntersecting ? "leftIn" : ""
                    } ${mode ? "dark" : "light-color"}`}
                  >
                    specializing in the MERN stack. I build dynamic web
                    applications with expertise in{" "}
                    <span className="text-orange-2">React.js</span>,
                    ...
                    <span className="text-orange-2"> MongoDB</span>, ensuring
                    seamless user experiences from concept to deployment.
                  </p>
                </div>
                <button
                  className={`nav-btn ${isBtnIntersecting ? "leftIn" : ""} ${
