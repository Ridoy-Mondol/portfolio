...
//             <div className="row">
//             <h3 className="text-center about-heading"><span className="border-heading text-white">About <span className="home-text">Me</span></span></h3> 
...
//                   <p className="my-description">Hey there! I'm Md. RIDOY MONDOL, a passionate full-stack developer specializing in the MERN stack. With a background in frontend design and a deep understanding of backend development, I bring a holistic approach to creating robust web applications.

// <h5 className="margin-heading">What I Do:</h5>

// <p className=""><span className="text-orange">🌐 Full-Stack Mastery:</span> I excel in building end-to-end web solutions using MongoDB, Express.js, React.js, and Node.js (MERN stack), ensuring both frontend elegance and backend efficiency.</p>

// <p className=""><span className="text-orange">🚀 Frontend Magic:</span>  Leveraging React.js, Next.js, JavaScript, HTML, CSS, Bootstrap and Tailwind CSS I develop responsive and interactive interfaces that engage users and enhance usability.</p>

// <p className=""><span className="text-orange">⚙️ Backend Expertise:</span> From database management to server-side logic, I implement CRUD operations, REST APIs, authentication, authorization, and caching to optimize performance and security.</p>
...
// </div>
// <button className= "nav-btn mt-4" onClick={showText}>{display ? "See Less" : "See More"}</button>
// </p>
