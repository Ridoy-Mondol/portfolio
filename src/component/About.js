          ...
          <div className="row">
            ...
            >
              <div ref={h4Ref} id="about-h4">
                <h4 className={`${isH4Intersecting ? "rightIn" : ""}`}>
                  Full Stack Web Developer
                </h4>
              </div>
              <div ref={h50Ref} id="about-h50" className="mt-3">
                <h5 className={`${isH50Intersecting ? "rightIn" : ""}`}>
                  Who I Am:
                </h5>
              </div>
              <div ref={p1Ref} id="about-p1">
                <p
                  className={`my-description ${
                    isP1Intersecting ? "rightIn" : ""
                  }`}
                >
                  Hi, I’m MD. AHATASHAMUL ISLAM MONDOL, a dedicated full-stack
                  developer who loves building web applications with the MERN
                  stack.
                </p>
              </div>
              <div ref={h51Ref} id="about-h51" className="mt-3">
                <h5 className={`${isH51Intersecting ? "rightIn" : ""}`}>
                  What I Do:
                </h5>
              </div>
              <div ref={p2Ref} id="about-p2">
                <p className={`${isP2Intersecting ? "rightIn" : ""}`}>
                  ...
                  efficient and user-friendly web apps.
                </p>
              </div>
              <div ref={p3Ref} id="about-p3">
                <p className={`${isP3Intersecting ? "rightIn" : ""}`}>
                  <span className="text-orange">🚀 Frontend Skills:</span> I
                  design engaging and responsive interfaces with React.js,
                  Next.js, JavaScript, HTML, CSS, Bootstrap, Tailwind CSS.
                </p>
              </div>
              <div ref={p4Ref} id="about-p4">
                <p className={`${isP4Intersecting ? "rightIn" : ""}`}>
                  <span className="text-orange">⚙️ Backend Expertise:</span> I
                  manage databases, server logic, APIs, authentication, and
                  caching to keep your app running smoothly and securely.
                </p>
              </div>
              {display && (
                <div className="overflow-hidden">
                  <div ref={h52Ref} id="about-h52" className="mt-3">
                    <h5 className={`${isH52Intersecting ? "rightIn" : ""}`}>
                      Why Work With Me:
                    </h5>
                  </div>
                  <div ref={p5Ref} id="about-p5">
                    <p className={`${isP5Intersecting ? "rightIn" : ""}`}>
                      <span className="text-orange">
                        ✅ Smooth Integration:{" "}
                      </span>
                      I ensure the frontend and backend work together perfectly
                      for a seamless user experience.
                    </p>
                  </div>
                  <div ref={p6Ref} id="about-p6">
                    <p className={`${isP6Intersecting ? "rightIn" : ""}`}>
                      <span className="text-orange">
                        ✅ Always Up-to-Date:{" "}
                      </span>
                      I keep up with new tech to make sure your project is
                      modern and future-proof.
                    </p>
                  </div>
                  <div ref={p7Ref} id="about-p7">
                    <p className={`${isP7Intersecting ? "rightIn" : ""}`}>
                      <span className="text-orange">
                        ✅ Collaborative Approach:{" "}
                      </span>{" "}
                      Whether you need a strong online presence or a developer
                      to collaborate with, I'm here to help turn your ideas into
                      reality.
                    </p>
                  </div>
                  <div ref={h53Ref} id="about-h53" className="mt-3">
                    <h5 className={`${isH53Intersecting ? "rightIn" : ""}`}>
                      Let's Create Something Beautiful Together!
                    </h5>
                  </div>
                  <div ref={p8Ref} id="about-p8">
                    <p className={`${isP8Intersecting ? "rightIn" : ""}`}>
                      Check out my portfolio to see my work and get in touch to
                      discuss your project.
                    </p>
                  </div>
                  <div ref={p9Ref} id="about-p9">
                    <p className={`${isP9Intersecting ? "rightIn" : ""}`}>
              ...
              <button
                className={`nav-btn ${isBtnIntersecting ? "rightIn" : ""} ${
                  mode ? "dark-btn about-btn-hover" : ""
                }`}
                onClick={showText}
                ref={btnRef}
                id="about-btn"
